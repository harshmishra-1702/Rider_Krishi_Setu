...
enum UserRole {
  rider(
    ...
    subtitle: 'Transport produce from farm gates to mandis & wholesale buyers',
    subtitleHindi: 'खेत से मंडी और खरीदारों तक ताजा फसल सुरक्षित पहुंचाएं',
    subtitleMarathi: 'शेतातून थेट मंडी व खरेदीदारांपर्यंत शेतमालाची वाहतूक करा',
  ...
  bulkBuyer(
    id: 'bulk_buyer',
    title: 'Bulk Buyer / Mandi Trader',
    titleHindi: 'थोक खरीदार / मंडी व्यापारी',
    titleMarathi: 'घाऊक खरेदीदार / व्यापारी',
